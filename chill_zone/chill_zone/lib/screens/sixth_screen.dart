                ...
                Positioned(
                  ...
                  child: Align(
                    child: SizedBox(
                      ...
                      height: 136 * fem,
                      child: Text(
                        'indique cuanto le ha afectado alguno de estos sintomas recientemente, temblor en las piernas o manos, mareos, sensacion de ahogo, desvanecimientos',
                        style: SafeGoogleFont(
                          'Raleway',
                          fontSize: 35 * ffem,
                          fontWeight: FontWeight.w700,
                      ...
                      children: [
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(
                              0 * fem, 3.71 * fem, 163.21 * fem, 0 * fem),
