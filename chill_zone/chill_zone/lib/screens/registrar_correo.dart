...
class RegistrarCorreo extends StatefulWidget {
  const RegistrarCorreo({Key? key}) : super(key: key);

  @override
  State<RegistrarCorreo> createState() => _RegistrarCorreoState();
}

class _RegistrarCorreoState extends State<RegistrarCorreo> {
                        ...
                        if(respuesta){
                          showDialog(context: context, builder: (context){
                            return AlertDialog(
                              ...
                              title: Text('Usuario registrado con éxito'),
                            );
                          });
                        }
                        else{
                          showDialog(context: context, builder: (context){
                            return const AlertDialog(title: Text('No se pudo registrar el usuario'),);
                          });
                        }
